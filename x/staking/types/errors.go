...
var (
	...
	ErrMinSelfDelegationTooLow         = sdkerrors.Register(ModuleName, 40, "min self delegation lower than "+MinSelfDelegation)
	ErrCommissionLTMinRate             = sdkerrors.Register(ModuleName, 41, "commission cannot be less than min rate")
	ErrUnbondingNotFound               = sdkerrors.Register(ModuleName, 42, "unbonding operation not found")
	ErrUnbondingOnHoldRefCountNegative = sdkerrors.Register(ModuleName, 43, "cannot un-hold unbonding operation that is not on hold")
)
